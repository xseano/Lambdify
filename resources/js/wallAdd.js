...
function process(parsedData) {
	...
	var newsMsgAddhoλ = document.getElementById("wallMxsAdd");
	var newsMsgAddTextNodeoλ = document.createTextNode(message);
	newsMsgAddhoλ.appendChild(newsMsgAddTextNodeoλ);
}